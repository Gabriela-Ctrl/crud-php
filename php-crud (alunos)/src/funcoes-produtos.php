<?php
    ...
    function inserirProdutos(PDO $conexao, string $nome, float $preco, int $quantidade, string $descricao, int $fabricanteId):void {// void indica sem retorno
        $sql = "INSERT INTO produtos(nome, preco, quantidade, descricao, fabricante_id) VALUE(:nome, :preco, quantidade, descricao, :fabricante_id)";
        ...
        try {
            ...
            $consulta->bindParam(':fabricante_id', $favricanteId, PDO::PARAM_INT);
    ...
    function atualizarProduto (PDO $conexao, int $id, string $none, float $preco, int $quantidade, string $descricao, int $fabricanteId) {
